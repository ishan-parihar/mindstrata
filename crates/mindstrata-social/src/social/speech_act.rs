...
pub enum SpeechActKind {
    /// Inform. (doc added at S3 extraction)
    Inform,
    /// Request. (doc added at S3 extraction)
    Request,
    /// Command. (doc added at S3 extraction)
    Command,
    /// Promise. (doc added at S3 extraction)
    Promise,
    /// Threaten. (doc added at S3 extraction)
    Threaten,
    /// Apologize. (doc added at S3 extraction)
    Apologize,
    /// Praise. (doc added at S3 extraction)
    Praise,
    /// Insult. (doc added at S3 extraction)
    Insult,
    /// Gossip. (doc added at S3 extraction)
    Gossip,
    /// Confess. (doc added at S3 extraction)
    Confess,
    /// Bless. (doc added at S3 extraction)
    Bless,
    /// Curse. (doc added at S3 extraction)
    Curse,
    /// Persuade. (doc added at S3 extraction)
    Persuade,
    /// Accuse. (doc added at S3 extraction)
    Accuse,
    /// Deny. (doc added at S3 extraction)
    Deny,
    /// Reassure. (doc added at S3 extraction)
    Reassure,
    /// Flirt. (doc added at S3 extraction)
    Flirt,
    /// Propose. (doc added at S3 extraction)
    Propose,
    /// Vow. (doc added at S3 extraction)
    Vow,
    /// Excommunicate. (doc added at S3 extraction)
    Excommunicate,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
pub enum ActDomain {
    /// Informational. (doc added at S3 extraction)
    Informational,
    /// Relational. (doc added at S3 extraction)
    Relational,
    /// Coercive. (doc added at S3 extraction)
    Coercive,
    /// Expressive. (doc added at S3 extraction)
    Expressive,
    /// Sacred. (doc added at S3 extraction)
    Sacred,
}
...
pub struct SpeechAct {
    ...
    /// Relational intent. (doc added at S3 extraction)
