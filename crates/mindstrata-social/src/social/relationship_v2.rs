...
pub enum RelationshipStage {
    /// Unnoticed. (doc added at S3 extraction)
    Unnoticed,
    /// Noticed. (doc added at S3 extraction)
    Noticed,
    /// Acquaintance. (doc added at S3 extraction)
    Acquaintance,
    /// Familiar. (doc added at S3 extraction)
    Familiar,
    /// Neighbor. (doc added at S3 extraction)
    Neighbor,
    /// Friend. (doc added at S3 extraction)
    Friend,
    /// CloseFriend. (doc added at S3 extraction)
    CloseFriend,
    /// Confidant. (doc added at S3 extraction)
    Confidant,
    /// Ally. (doc added at S3 extraction)
    Ally,
    /// Disliked. (doc added at S3 extraction)
    Disliked,
    /// Rival. (doc added at S3 extraction)
    Rival,
    /// Enemy. (doc added at S3 extraction)
    Enemy,
    /// Nemesis. (doc added at S3 extraction)
    Nemesis,
    /// Kin. (doc added at S3 extraction)
    Kin,
    /// ParentChild. (doc added at S3 extraction)
    ParentChild,
    /// Sibling. (doc added at S3 extraction)
    Sibling,
    /// Cousin. (doc added at S3 extraction)
    Cousin,
    /// InLaw. (doc added at S3 extraction)
    InLaw,
...
pub enum RelationshipLabel {
    ...
    /// InLaw. (doc added at S3 extraction)
    InLaw,
    /// AncestorDescendant. (doc added at S3 extraction)
    AncestorDescendant,
    /// PatronClient. (doc added at S3 extraction)
    PatronClient,
    /// LordVassal. (doc added at S3 extraction)
    LordVassal,
    /// MasterApprentice. (doc added at S3 extraction)
    MasterApprentice,
    /// PriestLayperson. (doc added at S3 extraction)
    PriestLayperson,
    /// ElderJunior. (doc added at S3 extraction)
    ElderJunior,
    /// GuardCitizen. (doc added at S3 extraction)
    GuardCitizen,
}
...
pub enum RoleExpectation {
    #[default]
    /// None. (doc added at S3 extraction)
    None,
    /// PatronClient. (doc added at S3 extraction)
    PatronClient,
    /// LordVassal. (doc added at S3 extraction)
    ...
    /// GuardCitizen. (doc added at S3 extraction)
    GuardCitizen,
    /// Provider. (doc added at S3 extraction)
    Provider,
    /// Caregiver. (doc added at S3 extraction)
    Caregiver,
    /// Protector. (doc added at S3 extraction)
    Protector,
    /// Ally. (doc added at S3 extraction)
    Ally,
}
...
pub enum BetrayalKind {
    /// Infidelity. (doc added at S3 extraction)
    Infidelity,
    /// Abandonment. (doc added at S3 extraction)
    Abandonment,
    /// Theft. (doc added at S3 extraction)
    Theft,
    /// Deception. (doc added at S3 extraction)
    Deception,
    /// Violence. (doc added at S3 extraction)
    Violence,
    /// BrokenVow. (doc added at S3 extraction)
    BrokenVow,
    /// Disloyalty. (doc added at S3 extraction)
    Disloyalty,
}
...
pub struct BetrayalEvent {
    /// Tick. (doc added at S3 extraction)
    pub tick: u64,
    /// Kind. (doc added at S3 extraction)
    pub kind: BetrayalKind,
    /// Magnitude. (doc added at S3 extraction)
    pub magnitude: Fixed,
}
...
pub enum ReconciliationKind {
    /// Apology. (doc added at S3 extraction)
    Apology,
    /// Reparation. (doc added at S3 extraction)
    Reparation,
    /// Mediation. (doc added at S3 extraction)
    Mediation,
    /// SharedRitual. (doc added at S3 extraction)
    SharedRitual,
    /// PublicAmends. (doc added at S3 extraction)
    PublicAmends,
}
...
pub struct RelationshipV2 {
    ...
    pub to: AgentId,
    /// Trust. (doc added at S3 extraction)
    pub trust: Fixed,
    /// Affection. (doc added at S3 extraction)
    pub affection: Fixed,
    /// Respect. (doc added at S3 extraction)
    pub respect: Fixed,
    /// Fear. (doc added at S3 extraction)
    pub fear: Fixed,
    /// Obligation. (doc added at S3 extraction)
    pub obligation: Fixed,
    /// Intimacy. (doc added at S3 extraction)
    pub intimacy: Fixed,
    /// Passion. (doc added at S3 extraction)
    pub passion: Fixed,
    /// Commitment. (doc added at S3 extraction)
    pub commitment: Fixed,
    /// Attachment security. (doc added at S3 extraction)
    pub attachment_security: Fixed,
    /// Dependence. (doc added at S3 extraction)
    pub dependence: Fixed,
    /// Power balance. (doc added at S3 extraction)
    pub power_balance: Fixed,
    /// Solidarity. (doc added at S3 extraction)
    pub solidarity: Fixed,
    /// Resentment. (doc added at S3 extraction)
    pub resentment: Fixed,
    /// Admiration. (doc added at S3 extraction)
    pub admiration: Fixed,
    /// Jealousy. (doc added at S3 extraction)
    pub jealousy: Fixed,
    /// Gratitude. (doc added at S3 extraction)
    pub gratitude: Fixed,
    /// Guilt toward. (doc added at S3 extraction)
    pub guilt_toward: Fixed,
    /// Moral debt. (doc added at S3 extraction)
    pub moral_debt: Fixed,
    /// Shared identity. (doc added at S3 extraction)
    pub shared_identity: Fixed,
    /// Stage. (doc added at S3 extraction)
    pub stage: RelationshipStage,
    /// Stage progress. (doc added at S3 extraction)
    pub stage_progress: Fixed,
    /// Interaction count. (doc added at S3 extraction)
    pub interaction_count: u32,
    /// Last positive tick. (doc added at S3 extraction)
    pub last_positive_tick: u64,
    /// Last negative tick. (doc added at S3 extraction)
    pub last_negative_tick: u64,
    /// Decay rate. (doc added at S3 extraction)
    pub decay_rate: Fixed,
    /// Volatility. (doc added at S3 extraction)
    ...
    /// Last update tick. (doc added at S3 extraction)
