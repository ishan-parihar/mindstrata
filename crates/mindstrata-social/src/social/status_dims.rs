...
pub struct StatusDimensions {
    /// Dominance. (doc added at S3 extraction)
    pub dominance: Fixed,
    /// Prestige. (doc added at S3 extraction)
    pub prestige: Fixed,
    /// Authority. (doc added at S3 extraction)
    pub authority: Fixed,
    /// Legitimacy. (doc added at S3 extraction)
    pub legitimacy: Fixed,
    /// Wealth rank. (doc added at S3 extraction)
    pub wealth_rank: Fixed,
    /// Moral reputation. (doc added at S3 extraction)
    pub moral_reputation: Fixed,
    /// Network centrality. (doc added at S3 extraction)
    ...
    /// Honor. (doc added at S3 extraction)
    pub honor: Fixed,
