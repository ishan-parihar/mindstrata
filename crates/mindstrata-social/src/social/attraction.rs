...
pub struct AttractionModel {
    /// Physical attraction. (doc added at S3 extraction)
    pub physical_attraction: Fixed,
    /// Personality attraction. (doc added at S3 extraction)
    pub personality_attraction: Fixed,
    /// Status attraction. (doc added at S3 extraction)
    pub status_attraction: Fixed,
    /// Moral attraction. (doc added at S3 extraction)
    pub moral_attraction: Fixed,
    /// Familiarity. (doc added at S3 extraction)
    pub familiarity: Fixed,
    /// Reciprocity. (doc added at S3 extraction)
    pub reciprocity: Fixed,
    /// Social approval. (doc added at S3 extraction)
    pub social_approval: Fixed,
    /// Kinship penalty. (doc added at S3 extraction)
    pub kinship_penalty: Fixed,
    /// Moral disgust. (doc added at S3 extraction)
    pub moral_disgust: Fixed,
    /// Social cost. (doc added at S3 extraction)
    ...
    /// Attachment resonance. (doc added at S3 extraction)
