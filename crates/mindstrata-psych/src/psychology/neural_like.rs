...
pub struct ConceptVector {
    /// Safety. (doc added at S3 extraction)
    pub safety: Fixed,
    /// Sacredness. (doc added at S3 extraction)
    pub sacredness: Fixed,
    /// Status. (doc added at S3 extraction)
    pub status: Fixed,
    /// Kinship. (doc added at S3 extraction)
    pub kinship: Fixed,
    /// Scarcity. (doc added at S3 extraction)
    pub scarcity: Fixed,
    /// Threat. (doc added at S3 extraction)
    pub threat: Fixed,
    /// Purity. (doc added at S3 extraction)
    pub purity: Fixed,
    /// Freedom. (doc added at S3 extraction)
    pub freedom: Fixed,
    /// Loyalty. (doc added at S3 extraction)
    pub loyalty: Fixed,
    /// Pleasure. (doc added at S3 extraction)
    pub pleasure: Fixed,
    /// Shame. (doc added at S3 extraction)
    pub shame: Fixed,
    /// Hope. (doc added at S3 extraction)
    pub hope: Fixed,
}
...
pub struct ActionValues {
    /// Need relief. (doc added at S3 extraction)
    pub need_relief: Fixed,
    /// Emotional relief. (doc added at S3 extraction)
    pub emotional_relief: Fixed,
    /// Social reward. (doc added at S3 extraction)
    pub social_reward: Fixed,
    /// Identity congruence. (doc added at S3 extraction)
    pub identity_congruence: Fixed,
    /// Learning rate. (doc added at S3 extraction)
    pub learning_rate: Fixed,
}
...
pub struct BehaviorScript {
    ...
    pub name: String,
    /// Steps. (doc added at S3 extraction)
    pub steps: Vec<String>,
    /// Current step. (doc added at S3 extraction)
