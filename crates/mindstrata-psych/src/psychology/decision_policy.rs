...
pub struct DecisionPolicy {
    /// Utility weights. (doc added at S3 extraction)
    pub utility_weights: UtilityWeights,
    /// Moral weights. (doc added at S3 extraction)
    pub moral_weights: MoralWeights,
    /// Risk policy. (doc added at S3 extraction)
    pub risk_policy: RiskPolicy,
    /// Social policy. (doc added at S3 extraction)
    pub social_policy: SocialPolicy,
    /// Habit policy. (doc added at S3 extraction)
    pub habit_policy: HabitPolicy,
    /// Emotional policy. (doc added at S3 extraction)
