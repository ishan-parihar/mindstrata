...
pub struct PerceivedEmotion {
    /// Valence. (doc added at S3 extraction)
    pub valence: Fixed,
    /// Arousal. (doc added at S3 extraction)
    pub arousal: Fixed,
    /// Is hostile. (doc added at S3 extraction)
    pub is_hostile: bool,
}
...
pub enum IntentPerception {
    /// Friendly. (doc added at S3 extraction)
    Friendly,
    /// Neutral. (doc added at S3 extraction)
    Neutral,
    /// Threatening. (doc added at S3 extraction)
    Threatening,
    /// Deceptive. (doc added at S3 extraction)
    Deceptive,
    #[default]
    /// Unknown. (doc added at S3 extraction)
    Unknown,
}
...
pub struct MindModels {
    /// Models. (doc added at S3 extraction)
