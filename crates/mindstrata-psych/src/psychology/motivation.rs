...
pub enum MotiveCategory {
    /// Hunger. (doc added at S3 extraction)
    Hunger,
    /// Thirst. (doc added at S3 extraction)
    Thirst,
    /// Sleep. (doc added at S3 extraction)
    Sleep,
    /// Warmth. (doc added at S3 extraction)
    Warmth,
    /// Health. (doc added at S3 extraction)
    Health,
    /// Safety. (doc added at S3 extraction)
    Safety,
    /// Attachment. (doc added at S3 extraction)
    Attachment,
    /// Belonging. (doc added at S3 extraction)
    Belonging,
    /// Esteem. (doc added at S3 extraction)
    Esteem,
    /// Autonomy. (doc added at S3 extraction)
    Autonomy,
    /// Competence. (doc added at S3 extraction)
    Competence,
    /// Meaning. (doc added at S3 extraction)
    Meaning,
    /// Certainty. (doc added at S3 extraction)
    Certainty,
    /// Novelty. (doc added at S3 extraction)
    Novelty,
    /// Play. (doc added at S3 extraction)
    Play,
    /// Care. (doc added at S3 extraction)
    Care,
    /// Romance. (doc added at S3 extraction)
    Romance,
    /// Justice. (doc added at S3 extraction)
    Justice,
    /// Recognition. (doc added at S3 extraction)
    Recognition,
}
