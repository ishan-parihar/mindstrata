...
pub struct EmotionDelta {
    ...
    pub fear: Fixed,
    /// Anger. (doc added at S3 extraction)
    pub anger: Fixed,
    /// Joy. (doc added at S3 extraction)
    pub joy: Fixed,
    /// Sadness. (doc added at S3 extraction)
    pub sadness: Fixed,
    /// Trust. (doc added at S3 extraction)
    pub trust: Fixed,
    /// Shame. (doc added at S3 extraction)
    pub shame: Fixed,
    /// Pride. (doc added at S3 extraction)
    pub pride: Fixed,
    /// Guilt. (doc added at S3 extraction)
    pub guilt: Fixed,
    /// §8.1.4 expanded emotion families (22 total).
    pub disgust: Fixed,
    /// Contempt. (doc added at S3 extraction)
    pub contempt: Fixed,
    /// Awe. (doc added at S3 extraction)
    pub awe: Fixed,
    /// Gratitude. (doc added at S3 extraction)
    pub gratitude: Fixed,
    /// Jealousy. (doc added at S3 extraction)
    pub jealousy: Fixed,
    /// Envy. (doc added at S3 extraction)
    pub envy: Fixed,
    /// Loneliness. (doc added at S3 extraction)
    pub loneliness: Fixed,
    /// Tenderness. (doc added at S3 extraction)
    pub tenderness: Fixed,
    /// Humiliation. (doc added at S3 extraction)
    pub humiliation: Fixed,
    /// Relief. (doc added at S3 extraction)
    pub relief: Fixed,
    /// Hope. (doc added at S3 extraction)
    pub hope: Fixed,
    /// Despair. (doc added at S3 extraction)
    pub despair: Fixed,
    /// Nostalgia. (doc added at S3 extraction)
    pub nostalgia: Fixed,
    /// Moral outrage. (doc added at S3 extraction)
