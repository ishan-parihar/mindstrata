...
use mindstrata_person::person::NeedState;
...
impl MarketState {
    ...
    pub fn new(params: &mindstrata_core::parameters::SimParameters) -> Self {
        Self {
...
pub enum TradeResult {
    /// Success. (doc added at S3 extraction)
    Success {
        /// U64. (doc added at S3 extraction)
        resource_id: u64,
        /// Fixed. (doc added at S3 extraction)
        quantity: Fixed,
        /// Fixed. (doc added at S3 extraction)
        price: Fixed,
        /// Fixed. (doc added at S3 extraction)
    ...
    /// InsufficientFunds. (doc added at S3 extraction)
    InsufficientFunds,
    /// InsufficientStock. (doc added at S3 extraction)
    InsufficientStock,
    /// NoMarket. (doc added at S3 extraction)
    NoMarket,
    /// NoPartner. (doc added at S3 extraction)
    NoPartner,
}
