...
pub enum LifeStage {
    /// Child. (doc added at S3 extraction)
    Child,
    /// Adolescent. (doc added at S3 extraction)
    Adolescent,
    /// Adult. (doc added at S3 extraction)
    Adult,
    /// Elder. (doc added at S3 extraction)
    Elder,
}
...
pub struct DemographyReport {
    /// Agents aged. (doc added at S3 extraction)
    pub agents_aged: usize,
    /// Births. (doc added at S3 extraction)
    pub births: usize,
    /// Deaths. (doc added at S3 extraction)
    pub deaths: usize,
    /// Agents migrated. (doc added at S3 extraction)
