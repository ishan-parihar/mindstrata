...
pub enum Season {
    /// Spring. (doc added at S3 extraction)
    Spring,
    /// Summer. (doc added at S3 extraction)
    Summer,
    /// Autumn. (doc added at S3 extraction)
    Autumn,
    /// Winter. (doc added at S3 extraction)
    Winter,
}
...
pub enum WeatherRegime {
    /// Normal. (doc added at S3 extraction)
    Normal,
    /// Drought. (doc added at S3 extraction)
    Drought,
    /// Flood. (doc added at S3 extraction)
    Flood,
}
...
pub enum WeatherEvent {
    /// DroughtStarted. (doc added at S3 extraction)
    DroughtStarted,
    /// FloodStarted. (doc added at S3 extraction)
    FloodStarted,
    /// DroughtEnded. (doc added at S3 extraction)
    DroughtEnded,
    /// FloodEnded. (doc added at S3 extraction)
    FloodEnded,
}
...
pub struct SeasonTracker {
    /// Current. (doc added at S3 extraction)
    pub current: Season,
    /// Tick in season. (doc added at S3 extraction)
    pub tick_in_season: u64,
    /// Ticks per season. (doc added at S3 extraction)
    pub ticks_per_season: u64,
    /// Year. (doc added at S3 extraction)
    pub year: u64,
}
