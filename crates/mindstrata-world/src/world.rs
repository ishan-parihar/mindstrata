...
pub enum Terrain {
    /// Grassland. (doc added at S3 extraction)
    Grassland,
    /// Forest. (doc added at S3 extraction)
    Forest,
    /// Hill. (doc added at S3 extraction)
    Hill,
    /// Mountain. (doc added at S3 extraction)
    Mountain,
    /// Water. (doc added at S3 extraction)
    Water,
    /// Desert. (doc added at S3 extraction)
    Desert,
    /// Swamp. (doc added at S3 extraction)
    Swamp,
}
...
pub struct Tile {
    /// Terrain. (doc added at S3 extraction)
    pub terrain: Terrain,
    /// Fertility. (doc added at S3 extraction)
    pub fertility: Fixed,
    /// Moisture. (doc added at S3 extraction)
    pub moisture: Fixed,
    /// Temperature. (doc added at S3 extraction)
    pub temperature: Fixed,
    /// Depletion. (doc added at S3 extraction)
    pub depletion: Fixed,
    /// Disease pressure. (doc added at S3 extraction)
    pub disease_pressure: Fixed,
    /// Owner. (doc added at S3 extraction)
    pub owner: Option<EntityId>,
    /// Site. (doc added at S3 extraction)
...
pub struct ResourceDef {
    ...
    pub name: String,
    /// Perishable. (doc added at S3 extraction)
    pub perishable: bool,
    /// Spoilage rate. (doc added at S3 extraction)
...
pub struct ResourceStock {
    /// Resource id. (doc added at S3 extraction)
    pub resource_id: u64,
    /// Quantity. (doc added at S3 extraction)
    pub quantity: Fixed,
    /// Quality. (doc added at S3 extraction)
    pub quality: Fixed,
...
pub struct Site {
    ...
    /// Owner. (doc added at S3 extraction)
    pub owner: Option<EntityId>,
    /// Capacity. (doc added at S3 extraction)
    pub capacity: u32,
    ...
    /// Inventory. (doc added at S3 extraction)
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum SiteKind {
    /// House. (doc added at S3 extraction)
    House,
    /// Farm. (doc added at S3 extraction)
    Farm,
    /// Well. (doc added at S3 extraction)
    Well,
    /// Market. (doc added at S3 extraction)
    Market,
    /// Temple. (doc added at S3 extraction)
    Temple,
    /// Barracks. (doc added at S3 extraction)
    Barracks,
    /// Workshop. (doc added at S3 extraction)
    Workshop,
    /// Square. (doc added at S3 extraction)
    Square,
    /// Prison. (doc added at S3 extraction)
    Prison,
    /// School. (doc added at S3 extraction)
    School,
}
...
pub struct Region {
    /// Name. (doc added at S3 extraction)
    pub name: String,
    /// Origin x. (doc added at S3 extraction)
    pub origin_x: i32,
    /// Origin y. (doc added at S3 extraction)
    pub origin_y: i32,
    /// Width. (doc added at S3 extraction)
    pub width: u32,
    /// Height. (doc added at S3 extraction)
    pub height: u32,
}
...
pub struct World {
    ...
    /// Height. (doc added at S3 extraction)
    pub height: u32,
    /// Tiles. (doc added at S3 extraction)
    pub tiles: Vec<Tile>,
    /// Sites. (doc added at S3 extraction)
    pub sites: Vec<Site>,
    /// Regions. (doc added at S3 extraction)
    pub regions: Vec<Region>,
    /// Resources. (doc added at S3 extraction)
