...
pub struct NeighborSettlement {
    ...
    pub relation: Fixed,
    /// Last raid tick. (doc added at S3 extraction)
    pub last_raid_tick: Option<u64>,
    /// Caravan count. (doc added at S3 extraction)
...
pub struct DiplomacyRegistry {
    /// Neighbors. (doc added at S3 extraction)
    pub neighbors: Vec<NeighborSettlement>,
    /// Raids. (doc added at S3 extraction)
    pub raids: u64,
    /// Caravans. (doc added at S3 extraction)
    pub caravans: u64,
    /// Pass count. (doc added at S3 extraction)
    pub pass_count: u64,
}
