...
pub struct Deity {
    ...
    pub name: String,
    /// Temperament. (doc added at S3 extraction)
...
pub struct Doctrine {
    /// Name. (doc added at S3 extraction)
    pub name: String,
    /// Precepts. (doc added at S3 extraction)
    pub precepts: Vec<String>,
    /// Sacred value. (doc added at S3 extraction)
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Religion {
    /// Deity. (doc added at S3 extraction)
    pub deity: Deity,
    /// Doctrine. (doc added at S3 extraction)
