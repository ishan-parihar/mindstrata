...
| `docs/PLAN_RUST_CRAFT_AUDIT.md` | HISTORICAL | rust-craft audit (2026-09-24) CLOSED — C1 flipped the gate to `--all-targets --locked -- -D warnings` and cleared the 339-site backlog; C2 suppression hygiene; C3 `total_cmp`; C4 both RoT groups rejected as test-fixture DAMP (recorded); C5 complexity numbers queued |
