...
| `docs/PLAN_RUST_CRAFT_AUDIT.md` | ACTIVE | rust-craft audit (2026-09-24) + fix ladder C1–C5; owns the `--all-targets` clippy inventory, the broken i286 census probe, and the gate-closure iteration |
