...
|---|---|---|
| Unit tests (sim) | 607 | Per-system correctness (incl. skeletal + digestive §7.2.3/§7.2.7 + relational power §11.2 + speech acts §8.1.11 + perception §8.1.2 + pregnancy §7.2.6 + memory §8.1.3) |
