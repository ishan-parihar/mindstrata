...
| i316+ | queued | — | Tier/scaling audit (`i316_tier_scaling` reconnaissance): Background tier unreachable, dead biology/action-selection tier gates, superlinear cost floor; levers row 3 residual (Q2 absence-growth dynamic range); re-measure the i306 meaning channel over the (no longer frailty-locked) population; (a) CLIENT asset-viewer panel over the i301 schema; (c) graphical shell spike; fatigue pace at 50K |
