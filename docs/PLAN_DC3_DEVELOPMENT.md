...
| i318+ | queued | — | (c) graphical shell spike over the same i301 document; levers row 3 residual (Q2 absence-growth dynamic range); re-measure the i306 meaning channel; fatigue pace at 50K; scale debt (sparse relationship store, Secondary biology path, Background reachability, VecDeque/claims triggers >250K ticks) |
