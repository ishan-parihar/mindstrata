...
| i321+ | queued | — | (c) graphical shell spike over the same i301 document; re-measure the i306 meaning channel; fatigue pace at 50K; scale debt (sparse relationship store, Secondary biology path, Background reachability, VecDeque/claims triggers >250K ticks) |
