...
| i310+ | queued | — | Gate split (acute vs chronic-frailty health) or mean-reverting chronic-load penalty; re-measure the i306 meaning channel over the frailty population; (a) CLIENT asset-viewer panel over the i301 schema; (c) graphical shell spike; fatigue pace at 50K; levers row-3 residuals (ceiling band, Q2 saturation) |
