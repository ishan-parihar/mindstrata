...
| i325+ | queued | — | scale debt (sparse relationship store, Secondary biology path, Background reachability, VecDeque/claims triggers >250K ticks); AA art/audio sub-charters may now be drafted against the v0 schema |
