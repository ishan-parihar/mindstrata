...
| i308+ | queued | — | (a) CLIENT asset-viewer panel over the i301 schema; (c) graphical shell spike; Rest-dominance equilibrium in the utility selector; fatigue pace at 50K; meaning-channel residual re-measure; levers row-3 residuals (ceiling band, Q2 saturation) |
