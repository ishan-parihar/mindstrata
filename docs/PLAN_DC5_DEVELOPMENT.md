...
**First arc status: i387 → i388 → i389 → i390 → i391 → i392 (rows 1 and 3 DONE; rows 2 and 4
rejected with records) and its precondition i392b DONE. Row 5 (`aggression_threshold`) is the
last unwired gene; then the next act item is i393 (the speech-act store).** i392's row 2 (`novelty_seeking` → the exploration driver) was
